...
function setGroupTargetLevel(groupType, value) {
    ...
    for (const card of cards) {
        ...
        if (targSelect) {
            targSelect.dispatchEvent(new Event('change', { bubbles: true }));
        }
    }
    refreshCalculations();
}
...
function refreshCalculations() {
    ...
    for (const card of cards) {
        ...
        const { stepPoints, costTotals, stepsCount, actualTo } = costs;
        let canAfford = true;
...
function loadGovCharm() {
    ...
    const charmGroups = [
        { type: 'Helmet', charms: ['Helmet Charm #1', 'Helmet Charm #2', 'Helmet Charm #3'] },
        { type: 'Watch', charms: ['Watch Charm #1', 'Watch Charm #2', 'Watch Charm #3'] },
        { type: 'Armor', charms: ['Armor Charm #1', 'Armor Charm #2', 'Armor Charm #3'] },
        { type: 'Pant', charms: ['Pant Charm #1', 'Pant Charm #2', 'Pant Charm #3'] },
        { type: 'Belt', charms: ['Belt Charm #1', 'Belt Charm #2', 'Belt Charm #3'] },
        { type: 'Weapon', charms: ['Weapon Charm #1', 'Weapon Charm #2', 'Weapon Charm #3'] }
    ];
