...
function refreshCalculations() {
    ...
    for (const card of cards) {
        ...
        if (isLocked) {
            ...
            const { stepPoints, costTotals, totalTimeSeconds, stepsCount, partialNote } = locked;
        ...
        const { stepPoints, totalTimeSeconds, costTotals, stepsCount, partialNote, actualTo } = costs;
        let canAfford = true;
